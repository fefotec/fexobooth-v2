...
def main() -> int:
    ...
    _check_contains(ci, "default: '2.4.71'", "build-release.yml: aktueller Build 2.4.71 als Default", errors)
    ...
    _check_contains(app_version, '__version__ = "2.4.71"', "src/__init__.py: App-Version 2.4.71", errors)
    _check_contains(installer, "FexoBooth_Setup_2.4.71.exe", "installer.iss: Versionsbeispiel 2.4.71", errors)
