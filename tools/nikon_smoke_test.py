...
def main() -> int:
    ...
    _check_contains(ci, "default: '2.4.73'", "build-release.yml: aktueller Build 2.4.73 als Default", errors)
    ...
    _check_contains(app_version, '__version__ = "2.4.73"', "src/__init__.py: App-Version 2.4.73", errors)
    _check_contains(installer, "FexoBooth_Setup_2.4.73.exe", "installer.iss: Versionsbeispiel 2.4.73", errors)
