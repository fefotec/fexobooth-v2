...
def main() -> int:
    ...
    _check_contains(ci, "default: '2.4.67'", "build-release.yml: aktueller Build 2.4.67 als Default", errors)
    ...
    _check_contains(app_version, '__version__ = "2.4.67"', "src/__init__.py: App-Version 2.4.67", errors)
    _check_contains(installer, "FexoBooth_Setup_2.4.67.exe", "installer.iss: Versionsbeispiel 2.4.67", errors)
